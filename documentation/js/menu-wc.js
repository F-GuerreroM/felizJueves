...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">feliz-jueves documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/RecoverComponent.html" data-type="entity-link" >RecoverComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/RecuperaComponent.html" data-type="entity-link" >RecuperaComponent</a>
                            </li>
                            <li class="link">
